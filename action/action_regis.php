...
function registrasi($nama, $password, $kelas, $sekolah, $email, $telp, $provinsi, $kabupaten, $kecamatan, $kelurahan)
{
    include '../conn.php';
...
$regis_success = registrasi($nama, $password, $kelas, $sekolah, $email, $telp, $provinsi, $kabupaten, $kecamatan, $kelurahan);
